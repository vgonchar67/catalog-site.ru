...
class GoodsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Catalog.Map.GoodsTableMap';
     ...
     */
    const OM_CLASS = '\\Catalog\\Goods';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Catalog.Goods';
     ...
     */
    const COL_ID = 'goods.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'goods.name';

    /**
     * the column name for the preview_text field
     */
    const COL_PREVIEW_TEXT = 'goods.preview_text';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Catalog\\Goods');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Catalog\Goods) { // it's a model object

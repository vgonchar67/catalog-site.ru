...
use \Exception;
use \PDO;
use Catalog\Category as ChildCategory;
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Catalog\Base\CategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'catalog-site', $modelName = '\\Catalog\\Category', $modelAlias = null)
    {

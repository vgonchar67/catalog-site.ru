...
class CategoryTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Propel\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Category';
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Product', '\\Propel\\Product', RelationMap::MANY_TO_MANY, array(), null, null, 'Products');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Category) { // it's a model object
